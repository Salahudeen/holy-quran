...
const LaunchRequestHandler = {
    ...
    async handle(handlerInput) {
        ...
        if (!playbackInfo.hasPreviousPlaybackSession) {
            message = 'Holy Quran with english translations. You can ask to play the audio to begin.';
...
const HelpHandler = {
    ...
    async handle(handlerInput) {
        ...
        if (!playbackInfo.hasPreviousPlaybackSession) {
            ...
            message = 'Holy Quran with english translations. You can say, Next or Previous to navigate through chapters. At any time, you can say Pause to pause the audio and Resume to resume.';
        }
